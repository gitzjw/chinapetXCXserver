...
class FileUpload
{
    ...
    /* 设置上传后的文件名称 */
    private function setNewFileName($uid=null)
    {
        if ($this->israndname) {
            $this->setOption('newFileName', $this->proRandName($uid));
        } else {
    ...
    /* 设置随机文件名 */
    private function proRandName($uid=null)
    {
        $fileName = date('YmdHis') . $uid ."_" . rand(100, 999);
